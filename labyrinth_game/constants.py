ROOMS = {
    ...
    'secret_room': {
        'description': (
            'Тайная комната с потайной дверью. Здесь можно найти легендарный '
            'ключ сокровищ.'
        ),
        'exits': {'south': 'armory'},
        'items': ['treasure_key'],
    ...
    'garden': {
        'description': 'Спокойный сад с фонтаном и цветами. Здесь можно отдохнуть.',
        'exits': {'west': 'entrance'},
        'items': ['flower'],
        'puzzle': None,
    },
...
COMMANDS = {
    "north / south / east / west": "перейти в направлении (можно без go)",
    "go <направление>": "перейти в направлении (альтернатива)",
    "look": "осмотреться",
